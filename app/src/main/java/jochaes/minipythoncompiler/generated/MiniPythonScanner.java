...
public class MiniPythonScanner extends Lexer {
	...
	public static final int
		...
		INTEGER=36, FLOAT=37, CHARCONST=38, STRING=39, NEWLINE=40, WS=41, LINECOMMENT=42, 
		COMMENT=43;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LETTER", "DIGIT", "NEWLINE", "WS", "LINECOMMENT", "COMMENT"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING", "NEWLINE", "WS", "LINECOMMENT", "COMMENT"
		};
	}
